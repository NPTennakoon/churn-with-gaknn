...
public class FastVector
    ...
    public class FastVectorEnumeration
        ...
        /**
         * Constructs an enumeration with a special element. The special element
         * is skipped during the enumeration.
         *
         * @param vector the vector which is to be enumerated
  ...
  //@ invariant 1 <= m_CapacityMultiplier;
    ...
    /**
     * Clones the vector and shallow copies all its elements. The elements have
     * to implement the Copyable interface.
     *
     * @return the new vector
     */
    ...
    /**
     * Returns an enumeration of this vector, skipping the element with the
     * given index.
     *
    ...
    //to retrieve the object at the given index
