...
public abstract class DataFileReader {
    ...
    public void LoadData() throws IOException {
        if (m_filePath.length() == 0) {
            ...
            System.out.println("file path1: " + m_filePath); //03-03-2013
            System.out.println("relation: " + m_RelationName);
            System.out.println("number of attributes: " + m_Attributes.size());
            numatts = m_Attributes.size();
