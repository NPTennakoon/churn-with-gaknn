...
public abstract class Predictor {
    ...
    public abstract Pair Predict(double[] instance, double t, double r);

    public abstract Pair Predict(double[] instance, double[] t);

    //  public abstract Pair Predict(double[] instance,int t);
//    public abstract Pair Predict(double[] d, double[][] trainSet, int[] trainIndex, int m_ClassAttribIndex) ;
