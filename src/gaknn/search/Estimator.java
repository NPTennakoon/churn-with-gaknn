 ...
 *
 * Example code for a nonincremental estimator <code>
 * <pre>
 ...
 * implement interface IncrementalEstimator) <code>
 * <pre>
 ...
 *
 *
 * Example code for a main method for an estimator. <p> <code> <pre> public
 * static void main(String [] argv) {
 *
 * try { LoglikeliEstimator est = new LoglikeliEstimator();
 * Estimator.buildEstimator((Estimator) est, arg v , false )
 * ;
 * S
 * ys
 * tem.out.println(est.toString());
 *   } catch (Exception ex) {
 *     ex.printStackTrace();
...
//  }
    /**
     * Initialize the estimator using only the instance of one class. It is
